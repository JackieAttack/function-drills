...
function nameCheck(name) {
  if(name === 'Steven') {
    ...
    return `Cool name, ${String(name)}`;
  }
}
let nameGreeting = nameCheck(1234);
...
function howManyFrogs2(gold) {
  let numFrogs = gold / 3;
  return Math.floor(numFrogs);
}
let totalFrogs2 = howManyFrogs2(7);
